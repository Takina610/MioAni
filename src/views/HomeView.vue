      ...
      <section class="closing-band reveal-section">
        ...
        <div class="closing-band__content">
          ...
          <div class="closing-band__actions">
            <RouterLink class="closing-band__cta" to="/library">
              <span class="closing-band__cta-label">进入我的追番库</span>
              <span class="closing-band__cta-arrows" aria-hidden="true">
                <svg width="50" height="20" viewBox="0 0 66 43" xmlns="http://www.w3.org/2000/svg">
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <path
                      class="closing-band__cta-arr closing-band__cta-arr--one"
                    ...
                    />
                    <path
                      class="closing-band__cta-arr closing-band__cta-arr--two"
                    ...
                    />
                    <path
                      class="closing-band__cta-arr closing-band__cta-arr--three"
            ...
            <RouterLink class="closing-band__send" to="/discover">
              <span class="closing-band__send-icon-wrap" aria-hidden="true">
                <span class="closing-band__send-icon">
              ...
              <span class="closing-band__send-label">去发现更多</span>
            </RouterLink>
          </div>
